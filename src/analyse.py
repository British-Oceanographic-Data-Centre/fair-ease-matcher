...
def analyse_from_geodab_terms(terms, restrict_to_theme, exclude_deprecated=False, match_properties=None) -> dict:                
...
def create_query(predicate, terms, query_type, theme_uris=None, proximity=False, exclude_deprecated=False, match_properties=None):
    queries = []
    ...
    query = template.render(
        predicate=predicate, terms=terms, proximity=proximity, theme_uris=theme_uris, exclude_deprecated=exclude_deprecated, match_properties=match_properties
